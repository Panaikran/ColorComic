...
"""PyInstaller one-folder build spec for the ColorComic CUDA preview desktop build.

CUDA preview only: the official supported Windows installer remains CPU-only.
...
BUILD_CACHE = PROJECT_ROOT / "build" / "hf-cache-cuda-preview"
